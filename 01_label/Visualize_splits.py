...
im = cv2.imread('interesting_pics/1.JPG')
fig,ax = plt.subplots(1, figsize=(20, 10))
ax.imshow(im)
rect = patches.Rectangle((0,0),w,h,linewidth=3,edgecolor='none',facecolor='white')
ax.add_patch(rect)

colors = ['#33658a', '#f6ae2d', '#f26419'] 

#rect = patches.Rectangle((0,0),w_new,h_new,linewidth=3, alpha=0.5, edgecolor=colors[0],facecolor=colors[0])
#ax.add_patch(rect) 
#
#rect = patches.Rectangle((minxs[1],minys[0]),w_new,h_new,linewidth=3, alpha=0.5, edgecolor=colors[1],facecolor=colors[1])
#ax.add_patch(rect)
#
#rect = patches.Rectangle((minxs[0],minys[1]),w_new,h_new,linewidth=3, alpha=0.5, edgecolor=colors[2],facecolor=colors[2])
#ax.add_patch(rect)   
 

colors = ['red', 'green', 'blue'] 
rect = patches.Rectangle((3500, 1357),325,325,linewidth=3, edgecolor='black', color = None, facecolor='white')
plt.text(3500 ,1357 + 500, 'Large', color='black', fontsize=18 )
ax.add_patch(rect)  

rect = patches.Rectangle((2500,1357 + 325-212 ),212,212,linewidth=3, edgecolor='black',color = None, facecolor='white')
plt.text(2500 ,1357 + 500, 'Medium', color='black', fontsize=18 )
ax.add_patch(rect)

rect = patches.Rectangle((1500,1357 + 325-106),106,106,linewidth=3, edgecolor='black' ,color = None,facecolor='white')
plt.text( 1500,1357 + 500, 'Small', color='black', fontsize=18 )
ax.add_patch(rect) 

rect = patches.Rectangle((500,1357 + 325-106),35,35,linewidth=3, edgecolor='black' ,color = None,facecolor='white')
plt.text( 500,1357 + 500, 'xS', color='black', fontsize=18 )
ax.add_patch(rect) 
...
#        c = colors[i]
#        print(c)
#        rect = patches.Rectangle((minx,miny),w_new,h_new,linewidth=3,edgecolor= c,facecolor=c, alpha=0.5)
#        ax.add_patch(rect)
